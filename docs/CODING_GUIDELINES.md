...
Tài liệu **thống nhất** cho repository Concert Ticket Booking (Geek Up — Product Backend Engineer Test): quy ước chung, cấu trúc thực tế của project, pattern backend/frontend, Git/CI, audit và checklist review.
